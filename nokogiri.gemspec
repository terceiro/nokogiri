...
Gem::Specification.new do |spec|
  ...
  spec.files = [
    ...
    "lib/nokogiri/jruby/net/sourceforge/htmlunit/neko-htmlunit/2.60.0/neko-htmlunit-2.60.0.jar",
  ...
  if java_p
    ...
    spec.requirements << "jar net.sourceforge.htmlunit, neko-htmlunit, 2.60.0"
