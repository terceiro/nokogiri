...
begin
  ...
  require 'net/sourceforge/htmlunit/neko-htmlunit/2.60.0/neko-htmlunit-2.60.0.jar'
...
if defined? Jars
  ...
  require_jar 'net.sourceforge.htmlunit', 'neko-htmlunit', '2.60.0'
...
module Nokogiri
  JAR_DEPENDENCIES = {"isorelax"=>"isorelax:isorelax:20030108", "neko-htmlunit"=>"net.sourceforge.htmlunit:neko-htmlunit:2.60.0", "jing"=>"nu.validator:jing:20200702VNU", "serializer"=>"xalan:serializer:2.7.2", "xalan"=>"xalan:xalan:2.7.2", "xercesImpl"=>"xerces:xercesImpl:2.12.2", "xml-apis"=>"xml-apis:xml-apis:1.4.01"}.freeze
